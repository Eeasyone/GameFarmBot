...
def main():
    while True:
        ...
        pyautogui.click(RND(70,105),RND(178,215))         # Кнопка инвентаря (самое левое положение)
        time.sleep(RND(2,3))                              # Рандом по ожиданию

        pyautogui.click(RND(82,389),RND(762,835))         # Нажимаем на отсек для руды
        time.sleep(RND(1,2))                              # Рандом по ожиданию

        pyautogui.click(RND(1360,1481),RND(900,1000))     # Нажимаем "Выбрать все" (Выбирает всю руду)
        time.sleep(RND(1,2))                              # Рандом по ожиданию
